...
const RU: Record<string, string> = {
  ...
  f_q7: 'Сколько времени занимает вывод средств?', f_a7: 'Вывод обрабатывается в течение 1–3 рабочих дней в зависимости от очереди выхода валидатора в сети Ethereum.',
  ...
  f_q9: 'Есть ли максимальный размер депозита?', f_a9: 'Максимальный депозит на один план — 128 ETH (4 позиции валидатора). Вы можете открыть несколько планов одновременно — ограничений на общую сумму нет.',
      ...
      <section id="trust" style={{ background: 'var(--bg2)' }}>
        <div className="wrap">
          ...
          {[
            ...
            [
              { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#60a5fa" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="8" cy="15" r="4"/><path d="M12 11.6L20 4"/><path d="M17 4l3 3"/><path d="M19 8l-2.5-2.5"/></svg>, h: t('pr_1h', lang, 'Custody partner'), p: t('pr_1p', lang, 'MPC infrastructure for non-custodial storage and signing.'), pwr: <a href="https://zodia-custody.com/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 7, justifyContent: 'center', color: 'inherit', textDecoration: 'none' }}><svg viewBox="0 0 22 22" width={22} height={22} style={{ borderRadius: '50%', flexShrink: 0 }}><rect width="22" height="22" rx="11" fill="#0d2580"/><text x="11" y="16" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold" fontFamily="Arial,sans-serif">Z</text></svg><span>Zodia Custody</span></a> },
              ...
              { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#60a5fa" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="10.5" cy="10.5" r="6.5"/><path d="M15.5 15.5L21 21"/><path d="M8 10.5l1.8 1.8 3-3"/></svg>, h: t('pr_3h', lang, 'Contract audit'), p: t('pr_3p', lang, 'Independent audit of smart contracts and infrastructure.'), pwr: <a href="https://hacken.io/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 7, justifyContent: 'center', color: 'inherit', textDecoration: 'none' }}><img src="https://github.com/hknio.png?size=22" width={22} height={22} style={{ borderRadius: '50%' }} alt="Hacken" onError={(e) => { e.currentTarget.src='https://avatars.githubusercontent.com/u/34027067?s=22'; }} /><span>Hacken</span></a> },
            ],
          ].map((row, ri) => (
        ...
        <div className="wrap">
          ...
          <div className="faq-wrap">
            {[
              ...
              { q: t('f_q7', lang, 'How long does withdrawal take?'), a: t('f_a7', lang, 'Withdrawals are processed within 1–3 business days depending on the Ethereum validator exit queue.') },
              ...
              { q: t('f_q9', lang, 'Is there a maximum deposit?'), a: t('f_a9', lang, 'The maximum deposit per plan is 128 ETH (4 validator positions). You can open multiple plans simultaneously — there is no cap on total staked amount.') },
